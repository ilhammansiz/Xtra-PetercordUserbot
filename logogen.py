        ...
        for i, image in enumerate(images):
            ...
            try: 
                ...
                try:
                    ...
                    with open("logo@ilhammansiez.jpg", "wb+") as f: 
                        f.write(r)
                    count += 1
            except: 
                pass
...
async def logogen(client, message):
    ...
    name = lmao[0]
    mainne(name, typeo)
    caption = "<b>Logo Generated By Petercord_Userbot. Get Petercord_Userbot From @ilhammansiez<b>"
    pate = "logo@ilhammansiez.jpg"
